...
export default class ResidualBox extends React.Component{
    ...
    render() {
        return <div style={{ width: this.props.width, height: this.props.height, position: "relative", paddingLeft: "20px", paddingBottom: "20px", margin: "10px"}}>
            ...
            {data.length ? <>
                <div style={{position: "absolute", top: 0, left: 0, alignItems: "center"}}>
                    <p style={{writingMode: "vertical-lr", textOrientation: "upright"}}>Resiual</p>
                </div>
